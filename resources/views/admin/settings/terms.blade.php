...
<section class="content-header clearfix">
 ...
 <h4 class="pull-left">Terms
  <small> Update Terms</small>
</h4>

<div class="pull-right">
  <div class="col-md-12 text-right">

    <button type="submit" class="btn btn-primary margin-r-5" ><i class="fa fa-save margin-r-5"></i>Update Terms</button>
