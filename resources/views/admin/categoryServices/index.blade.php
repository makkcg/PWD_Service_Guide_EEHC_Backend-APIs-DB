...
@section('header-content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Display categories for shop</li>
        </ol>
    </section>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @forelse($items as $key=>$item)
                                <tr>
                                    ...
                                    <td>{{ ($item->place == 1) ? 'At salon'  : 'At home' }}</td>
                                    <td>
                                        <form action="{{route('admin.categoryServices.destroy',$item)}}" method="post">

                                            <a href="{{route('admin.categoryServices.edit',$item)}}"
