  ...
  $(document).ready(function() {
      $('.deleteTitleSound').click(function() {
          var soundID = $(this).val();
              $.ajax({
                  url: '/admin/documents/title_sound/ajax/'+soundID,
                  type: "GET",
                  dataType: "json",
                  success:function(data) {
                      console.log('deleted');
...
<script type="text/javascript">
  $(document).ready(function() {
      $('.deleteDescSound').click(function() {
          var soundID = $(this).val();
              $.ajax({
                  url: '/admin/documents/desc_sound/ajax/'+soundID,
                  type: "GET",
                  dataType: "json",
                  success:function(data) {
                      console.log('deleted');
  ...
  $(document).ready(function() {
      $('.deleteTitleVideo').click(function() {
          var videoID = $(this).val();
              $.ajax({
                  url: '/admin/documents/title_video/ajax/'+videoID,
                  type: "GET",
                  dataType: "json",
                  success:function(data) {
                      console.log('deleted');
...
$(document).ready(function() {
    $('.deleteDescVideo').click(function() {
        var videoID = $(this).val();
            $.ajax({
                url: '/admin/documents/desc_video/ajax/'+videoID,
                type: "GET",
                dataType: "json",
                success:function(data) {
                    console.log('deleted');
