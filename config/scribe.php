...
return [
     ...
     */
    'base_url' => (env("APP_ENV") == "local" ? "http://basmety.test" : "https://api.4fdev.com/basmety"),
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'You can retrieve your token by visiting <b>Login API</b>.</br>All APIs <b>Must</b> have version Header <b>Api-Version:v1</b>.</br>All APIs <b>May</b> have locale Header <b>Api-Locale:ar</b>.',
    ],
...
INTRO,
    ...
    'postman' => [
         ...
         */
        'overrides' => [
            'variable.0.value' => (env("APP_ENV") == "local" ? "basmety.test" : "api.4fdev.com/basmety"),
            // 'info.version' => '2.0.0',
        ],
    ],
